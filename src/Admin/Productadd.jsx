...
const Productadd = () => {
    ...
    const Product_add_to_view_page = () => {
        if (!Product_Name || !Price || !Image_1 || !Image_2 || !Marketstatus || !status || !catogery) {
        ...
        if (editData) {
            ...
            axios.post(`http://localhost:3030/AllProduct_show_shop_page/${editData}`, {
    ...
    const updatedata = () => {
        axios.post(`http://localhost:3030/AllProduct_show_shop_page/${id}`)
            .then((response) => {
            ...
            <form style={{ overflow: "hidden" }}>
                ...
                <div className="row justify-content-center ">
                    <div className="col-5 text-center">
                        {
                            editData ? (
                                <button onClick={() => Product_add_to_view_page()}>update Product</button>

                            ) : (
                                <button onClick={() => Product_add_to_view_page()}>Add Product</button>
